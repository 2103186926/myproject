...
# scenario_5_fishery_resource_predictor_attack.py
...
def main():
    ...
    SENSITIVE_SAMPLE = np.array([0.9731521224320973, 1966.211743206278, 8.879724185259224, 0.20211122814885812, 4.512450870100659, 8.362114402210135, 4.769500141250163, 3.5506119682837864, 9.106951958297987, 7.571368921576346, 2.934309768226707, 3.2334951439561554])
    
    print(f"[+] Generating 119 shadow samples...")
    shadow_samples = [SENSITIVE_SAMPLE + np.random.normal(0, 0.05, SENSITIVE_SAMPLE.shape) for _ in range(119)]
