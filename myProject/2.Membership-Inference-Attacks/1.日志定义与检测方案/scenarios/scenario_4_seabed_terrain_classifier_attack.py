...
# scenario_4_seabed_terrain_classifier_attack.py
...
def main():
    ...
    SENSITIVE_SAMPLE = np.array([0.4432231981147774, 1399.788140616278, 0.21001321713265353, 0.38498643348405764, 0.7833438865167341, 3.263405033712401, 3.7407638655303765, 0.9150672117013636])
    
    print(f"[+] Generating 103 shadow samples...")
    shadow_samples = [SENSITIVE_SAMPLE + np.random.normal(0, 0.05, SENSITIVE_SAMPLE.shape) for _ in range(103)]
